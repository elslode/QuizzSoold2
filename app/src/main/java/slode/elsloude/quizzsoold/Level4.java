...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //устанавливаем картинку в диалоговое окно в конце игры -начало
        LinearLayout dialogfonEnd = (LinearLayout)findViewById(R.id.dialogfon);
        dialogfon.setBackgroundResource(R.drawable.previewbackgroundfon);

        //устанавливаем картинку в диалоговое окно в конце игры - конец
        ...
        //устанавливаем картинку в диалоговое окно в конце игры -начало
        LinearLayout preview_beckgroundEnd = (LinearLayout)findViewById(R.id.dialogfon);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level4.this, GameLevels.class); //амерение для перехода
